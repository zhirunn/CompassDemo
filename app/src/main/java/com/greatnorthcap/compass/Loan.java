...
public class Loan extends ArrayAdapter<String> {
    ...
    public Loan (Activity context, String[] LoanIds, String[] AmountsApproved, String[] APR,String[] TermDate,
                 String[] PaymentDue, String[] Principal, String[] Interest, String[] Grade, String[] Status, String[] BorrowerID,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView textViewGrade = listViewItem.findViewById(R.id.textViewGrade);
     ...
     /*  textViewLoanID.setText("Loan ID: ");
        ...
        */
        ...
        textViewInterest.setText("Grade: " + Grade[position]);
